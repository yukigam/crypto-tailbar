    ...
    courses: [
      {
        ...
        quiz: [
          { question: 'Спред (Spread) гэж юу вэ?', options: ['Худалдан авах үнэ', 'Ask ба Bid-ийн зөрүү', 'Брокерын шимтгэл'], correct: 1 },
          { question: '1 стандарт лот хэдэн нэгжтэй тэнцэх вэ?', options: ['1,000', '10,000', '100,000'], correct: 2 },
          { question: 'Үнийн хөдөлгөөнийг юу тодорхойлдог вэ?', options: ['Техник анализ', 'Эрэлт ба нийлүүлэлт', 'Индикаторууд'], correct: 1 },
        ],
        content: [
      ...
      },
      {
        ...
        quiz: [
          { question: 'Японы лаа (Candlestick) бүр хэдэн үнийн мэдээллийг агуулдаг вэ?', options: ['2', '3', '4'], correct: 2 },
          { question: 'Ногоон лаа юуг илтгэдэг вэ?', options: ['Үнэ өөрчлөгдөөгүй', 'Үнэ буурсан', 'Үнэ өссөн'], correct: 2 },
          { question: 'Урт доод сүүл (Wick) юуг илтгэдэг вэ?', options: ['Худалдагчдын давуу байдал', 'Худалдан авагчдын дэмжлэг', 'Зах зээлийн тогтвортой байдал'], correct: 1 },
        ],
        content: [
      ...
      },
      {
        ...
        quiz: [
          { question: '10x хөшүүрэгтэйгээр $100 барьцаагаар хэдэн төгрөгийн арилжаа нээх боломжтой вэ?', options: ['$200', '$500', '$1,000'], correct: 2 },
          { question: 'Margin Call гэж юу вэ?', options: ['Ашигтай арилжаа', 'Барьцаа нэмэх шаардлага', 'Арилжаа хаах'], correct: 1 },
          { question: 'Анхлан суралцагчдад ямар хөшүүрэг хэрэглэхийг зөвлөдөг вэ?', options: ['10x-20x', '3x-5x', '50x-100x'], correct: 1 },
        ],
        content: [
    ...
    courses: [
      {
        ...
        quiz: [
          { question: 'Дэмжлэг (Support) гэж юу вэ?', options: ['Үнэ өсөхөд саад болох түвшин', 'Үнэ буухад түшиг болох түвшин', 'Дундаж үнийн түвшин'], correct: 1 },
          { question: 'Эсэргүүцлийн түвшин эвдрэхэд (Breakout) юу болох вэ?', options: ['Эсэргүүцэл хэвээр байна', 'Дэмжлэг болж хувирна', 'Чиглэлээ алдана'], correct: 1 },
          { question: 'Хуурамч эвдрэл (Fakeout)-ээс сэргийлэх арга юу вэ?', options: ['Түвшинд хүрсэн даруйд арилжаа нээх', 'Түвшинг хааж чадсаныг баталгаажуулах', 'Хөшүүргийг нэмэгдүүлэх'], correct: 1 },
        ],
        content: [
      ...
      },
      {
        ...
        quiz: [
          { question: 'Зах зээлд хэдэн төрлийн трэнд байдаг вэ?', options: ['2', '3', '4'], correct: 1 },
          { question: 'Трэнд шугам (Trendline) зурахад хамгийн багадаа хэдэн цэг шаардлагатай вэ?', options: ['1', '2', '4'], correct: 1 },
          { question: '"The trend is your friend" гэдэг нь юу гэсэн үг вэ?', options: ['Трэндээс эсрэг арилжаа хийх', 'Трэндийн чиглэлд арилжаа хийх', 'Трэндийг үл тоомсорлох'], correct: 1 },
        ],
        content: [
      ...
      },
      {
        ...
        quiz: [
          { question: 'RSI ямар утгад хэт худалдан авалт (Overbought) гэж үздэг вэ?', options: ['30-аас доош', '50', '70-аас дээш'], correct: 2 },
          { question: 'MACD ямар үзүүлэлтүүдийн зөрүүгээр тооцогддог вэ?', options: ['2 шилжих дундаж (EMA)', 'RSI ба Stochastic', 'Боллинжерийн зурвас'], correct: 0 },
          { question: 'Индикаторуудыг хэрхэн ашиглах нь хамгийн үр дүнтэй вэ?', options: ['Дангаар нь', 'Графикын шинжилгээтэй хавсран', 'Зөвхөн RSI'], correct: 1 },
        ],
        content: [
    ...
    courses: [
      {
        ...
        quiz: [
          { question: 'Нэг арилжаанд дансны хэдэн хувийг эрсдэлд оруулахыг зөвлөдөг вэ?', options: ['5-10%', '1-2%', '20-30%'], correct: 1 },
          { question: 'Risk/Reward харьцаа 1:3 гэдэг нь юу гэсэн үг вэ?', options: ['$1 эрсдэлд $3 ашиг', '$3 эрсдэлд $1 ашиг', '1:3 харьцаатай спред'], correct: 0 },
          { question: 'Портфолиогийн төрөлжилт (Diversification) яагаад чухал вэ?', options: ['Ашиг нэмэгдүүлэх', 'Эрсдэлийг бууруулах', 'Тарифыг багасгах'], correct: 1 },
        ],
        content: [
      ...
      },
      {
        ...
        quiz: [
          { question: 'FOMO гэж юу вэ?', options: ['Алдагдал хүлээх айдас', 'Боломжоос хоцрох айдас', 'Зах зээлд үл итгэх байдал'], correct: 1 },
          { question: 'Сэтгэл зүйгээ хянах хамгийн үр дүнтэй арга юу вэ?', options: ['Зөн совингоор арилжаа хийх', 'Тодорхой төлөвлөгөөтэй арилжаа хийх', 'Хөшүүргийг өндөр тохируулах'], correct: 1 },
          { question: 'Амжилттай арилжаачид алдагдлыг хэрхэн хүлээн авдаг вэ?', options: ['Үргэлжлүүлэн том арилжаа хийх', 'Сургамж болгон авч системээ сайжруулах', 'Зах зээлээс гарах'], correct: 1 },
        ],
        content: [
...
export default function EducationPage() {
  ...
  const score = selectedLesson && quizSubmitted
      ...
      {isModalOpen && selectedLesson && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div onClick={e => e.stopPropagation()}
              ...
              {!showQuiz ? (
                <div className="space-y-4 text-sm text-slate-300 leading-relaxed">
                  {selectedLesson.content.map((paragraph, pi) => (
                    <p key={pi} className="text-justify">{paragraph}</p>
                  ))}
                  <div className="pt-4 flex justify-center">
                    <button onClick={() => { setShowQuiz(true); setQuizAnswers([]); setQuizSubmitted(false); }}
                      className="px-8 py-3 rounded-xl text-sm font-bold bg-blue-600 hover:bg-blue-500 text-white transition-all shadow-lg shadow-blue-600/20 active:scale-[0.98]">
                      📝 Мэдлэгээ шалгах
                    </button>
                  </div>
                </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm font-bold text-slate-200">Мэдлэгээ шалгах тест</span>
                    <span className="text-xs text-slate-500 ml-auto">{selectedLesson.quiz.length} асуулт</span>
                  </div>
                  ...
                  {selectedLesson.quiz.map((q, qi) => {
                    ...
                    return (
                      <div key={qi} className={`p-4 rounded-xl border transition-all ${quizSubmitted ? (selected === q.correct ? 'border-green-700 bg-green-900/20' : 'border-red-700 bg-red-900/20') : 'border-slate-700 bg-slate-800/50'}`}>
                        <p className="text-sm font-semibold mb-3 text-slate-200">{qi + 1}. {q.question}</p>
                        <div className="space-y-2">
                          {q.options.map((opt, oi) => {
                            let optStyle = 'border-slate-700 bg-slate-800/50 hover:bg-slate-700 text-slate-300';
                            if (quizSubmitted && oi === q.correct) optStyle = 'border-green-600 bg-green-900/30 text-green-300';
                            else if (isWrong && oi === selected) optStyle = 'border-red-600 bg-red-900/30 text-red-300';
                            ...
                            return (
                              <button key={oi} onClick={() => {
                                ...
                                className={`w-full text-left px-4 py-2.5 rounded-lg border text-sm font-medium transition-all ${optStyle} ${!quizSubmitted && selected === oi ? 'ring-2 ring-blue-500 border-blue-500' : ''}`}>
                  ...
                  {!quizSubmitted ? (
                    <button onClick={() => setQuizSubmitted(true)} disabled={quizAnswers.length < selectedLesson.quiz.length}
                      className={`w-full py-3 rounded-xl text-sm font-bold transition-all ${
                        quizAnswers.length < selectedLesson.quiz.length
                          ? 'bg-slate-700 text-slate-500 cursor-not-allowed'
                          : 'bg-green-600 hover:bg-green-500 text-white shadow-lg shadow-green-600/20 active:scale-[0.98]'
                      }`}>
                      {quizAnswers.length < selectedLesson.quiz.length ? 'Бүх асуултад хариулана уу' : '✅ Хариултаа шалгах'}
                    </button>
                  ) : (
                    <div className="text-center py-5 space-y-2">
                      <div className="text-3xl">
                        {score === selectedLesson.quiz.length ? '🏆' : score >= selectedLesson.quiz.length / 2 ? '👍' : '💪'}
                      </div>
                      <p className="text-lg font-bold text-slate-200">
                        {selectedLesson.quiz.length}-аас {score} зөв хариуллаа!
                      </p>
                      <p className="text-sm text-slate-400">
                        {score === selectedLesson.quiz.length
                          ? 'Та дараагийн хичээлд бэлэн үү? 🚀'
                          : score >= selectedLesson.quiz.length / 2
                          ? 'Сайн үр дүн! Дахин нэг уншиж үзээрэй.'
                          : 'Хичээлээ дахин уншиж үзэхийг зөвлөж байна.'}
                      </p>
                    </div>
                  )}
                </div>
            ...
            {/* footer */}
            <div className="px-6 py-4 border-t border-slate-800 flex justify-between items-center gap-2">
              {showQuiz && !quizSubmitted && (
                <button onClick={() => setShowQuiz(false)}
                  className="px-4 py-2.5 rounded-xl text-sm font-medium bg-slate-800 hover:bg-slate-700 text-slate-300 transition-all">
                  ← Текст унших
                </button>
              )}
