            ...
            <div className="responsive-grid">
              ...
              <aside style={{display:"flex",flexDirection:"column",gap:24}}>
                ...
                <div style={{border:`1.5px solid #f7931a44`,borderRadius:8,padding:"18px",background:"#fffbf5"}}>
                  ...
                  <IconButton style={{width:"100%",padding:"9px",background:"#f7931a",border:"none",color:"#000",borderRadius:6,fontWeight:700,cursor:"pointer",fontSize:13,fontFamily:"sans-serif"}} onClick={()=>window.open('https://www.binance.com/register?ref=561538131','_blank')}>Нэгдэх →</IconButton>
                </div>
